...
### NIT-05 — Verify circular imports stay clean — **LOW** — DONE `<MERGE_SHA>`
...
| NIT-05                      | Add `madge --circular` CI check — DONE `<MERGE_SHA>`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
