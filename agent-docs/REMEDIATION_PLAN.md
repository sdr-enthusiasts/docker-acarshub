...
| ID                             | Description                                                                                                        | Status                                                                                                                                                                                                                                                       |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| TEST-GAP-FE (services & infra) | `services/socket.ts`, `audioService.ts`, `utils/logger.ts`, `utils/spriteLoader.ts`, `utils/version.ts`, `App.tsx` | `socket.ts` ✅ merge `804ef64f` (commit `39afd95d`); `audioService.ts` ✅ merge `4269acf7` (`3a6bd47f`); `utils/logger.ts` ✅ merge `92873b1b` (`4003166f`); `utils/spriteLoader.ts` ✅ (merge after sprite-loader commit; unreachable error branch flagged) |
