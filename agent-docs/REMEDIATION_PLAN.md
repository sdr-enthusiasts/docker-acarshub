...
| NIT-07                      | Update stale `LATEST_REVISION` constant in `acarshub-backend/src/db/migrate.ts:50` from `"803398f85958"` to `"8c9d47f5ed13"` (the actual latest at `migrate.ts:1361`). Cosmetic — only used in log strings — but misleading and surfaced repeatedly while writing Phase 6 TEST-GAP-BE migrate.ts tests. Pairs naturally with GOD-02 (split `db/migrate.ts`) since the constant should live next to the migration array.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
