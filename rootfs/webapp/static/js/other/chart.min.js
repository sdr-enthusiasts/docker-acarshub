...
!(function (t, e) {
    ...
    getOptionScopes(t, e, i) {
      ...
      e.forEach((e) => {
        t && (r.add(t), e.forEach((e) => Hn(r, t, e))),
          ...
          e.forEach((t) => Hn(r, xt, t)),
          e.forEach((t) => Hn(r, gt, t));
      });
      const l = [...r];
  ...
  Object.defineProperties(Jn, {
    ...
    version: { enumerable: eo, value: "3.2.1" },
        ...
        { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = (function (t, e, i) {
          ...
          if (e < _t) {
            const r = t,
              ...
              g = (t, e, n) =>
                Ht(t, r, l) ? -1 : Math.min(e, e * i, n, n * i),
              p = f(0, c, d),
              m = f(Mt, h, u),
              x = g(bt, c, d),
              b = g(bt + Mt, h, u);
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        for (
          ...
          i.push({ value: Math.round((y + k * M) * _) / _ });
        return (
          m
            ? Tt(i[i.length - 1].value, s, b * (h ? ("" + s).length : 1))
