...
# echo "==== Checking vdlm2_server ====="
# echo "TCP4 listening on 0.0.0.0:15555 (tcp) for PID 396: PASS"
# echo "vdlm2_server TCP listening on port 15555 (pid 396): HEALTHY"
# echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15555 for python3 established: PASS"
# echo "vdlm2_server TCP connected to python server on port 15555: HEALTHY"
# echo "==== Checking vdlm2_stats ====="
# echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15555 for PID 27390 established: PASS"
# echo "vdlm2_stats (pid 27390) connected to acars_server (pid 396) at 127.0.0.1:15555: HEALTHY"
# echo "==== Check for VDLM2 activity ====="
# echo "0 VDLM2 messages received in past hour: UNHEALTHY"
# echo "==== Checking acars_server ====="
# echo "TCP4 listening on 0.0.0.0:15550 (tcp) for PID 400: PASS"
# echo "acars_server TCP listening on port 15550 (pid 400): HEALTHY"
# echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15550 for python3 established: PASS"
# echo "acars_server TCP connected to python3 server on port 15550: HEALTHY"
# echo "==== Checking acars_stats ====="
# echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15550 for PID 27421 established: PASS"
# echo "acars_stats (pid 27421) connected to acars_server (pid 400) at 127.0.0.1:15550: HEALTHY"
# echo "==== Check for ACARS activity ====="
# echo "17216 ACARS messages received in past hour: HEALTHY"
# echo "==== Check webapp ====="
# echo "webapp available: HEALTHY"
# echo "==== Check Service Death Tallies ====="
# echo "abnormal death tally for database_upkeep since last check is: 0: HEALTHY"
# echo "abnormal death tally for acars_feeder since last check is: 0: HEALTHY"
# echo "abnormal death tally for webapp since last check is: 0: HEALTHY"
# echo "abnormal death tally for acars_stats since last check is: 0: HEALTHY"
# echo "abnormal death tally for nginx since last check is: 0: HEALTHY"
# echo "abnormal death tally for vdlm2_stats since last check is: 0: HEALTHY"
# echo "abnormal death tally for acars_server since last check is: 0: HEALTHY"
# echo "abnormal death tally for vdlm2_feeder since last check is: 0: HEALTHY"
# echo "abnormal death tally for rrd-images since last check is: 0: HEALTHY"
# echo "abnormal death tally for vdlm2_server since last check is: 0: HEALTHY"

echo "==== Checking acarsdec-00012095 ====="
echo "UDP4 connection between 127.0.0.1:ANY and 127.0.0.1:5550 for PID 444 established: PASS"
echo "Decoder acarsdec-00012095 (pid 444) is connected to acars_server at 127.0.0.1:5550: HEALTHY"
echo "==== Checking dumpvdl2-00012507 ====="
echo "UDP4 connection between 127.0.0.1:ANY and 127.0.0.1:5555 for PID 450 established: PASS"
echo "Decoder dumpvdl2-00012507 (pid 450) is connected to vdlm2_server at 127.0.0.1:5555: HEALTHY"
echo "==== Checking vdlm2_server ====="
echo "TCP4 listening on 0.0.0.0:15555 (tcp) for PID 427: PASS"
echo "vdlm2_server TCP listening on port 15555 (pid 427): HEALTHY"
echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15555 for python3 established: PASS"
echo "vdlm2_server TCP connected to python server on port 15555: HEALTHY"
...
echo "vdlm2_stats (pid 508) connected to acars_server (pid 427) at 127.0.0.1:15555: HEALTHY"
echo "==== Check for VDLM2 activity ====="
echo "10 VDLM2 messages received in past hour: HEALTHY"
echo "==== Checking acars_server ====="
echo "TCP4 listening on 0.0.0.0:15550 (tcp) for PID 431: PASS"
echo "acars_server TCP listening on port 15550 (pid 431): HEALTHY"
echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15550 for python3 established: PASS"
echo "acars_server TCP connected to python3 server on port 15550: HEALTHY"
echo "==== Checking acars_feeder ====="
echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15550 for PID 509 established: PASS"
echo "acars_feeder (pid 509) is connected to acars_server (pid 431) at 127.0.0.1:15550: HEALTHY"
echo "UDP4 connection between ANY:ANY and ANY:5550 for PID 509 established: PASS"
echo "acars_feeder (pid 509) is feeding: HEALTHY"
echo "==== Checking acars_stats ====="
echo "TCP4 connection between 127.0.0.1:ANY and 127.0.0.1:15550 for PID 471 established: PASS"
echo "acars_stats (pid 471) connected to acars_server (pid 431) at 127.0.0.1:15550: HEALTHY"
echo "==== Check for ACARS activity ====="
echo "10 ACARS messages received in past hour: HEALTHY"
echo "==== Check webapp ====="
echo "webapp available: HEALTHY"
echo "==== Check Service Death Tallies ====="
echo "abnormal death tally for vdlm2_server since last check is: 0: HEALTHY"
echo "abnormal death tally for vdlm2_feeder since last check is: 0: HEALTHY"
echo "abnormal death tally for webapp since last check is: 0: HEALTHY"
echo "abnormal death tally for planeplotter-server since last check is: 0: HEALTHY"
echo "abnormal death tally for acars_stats since last check is: 0: HEALTHY"
echo "abnormal death tally for dumpvdl2-00012507 since last check is: 0: HEALTHY"
echo "abnormal death tally for nginx since last check is: 0: HEALTHY"
echo "abnormal death tally for vdlm2_stats since last check is: 0: HEALTHY"
echo "abnormal death tally for acars_feeder since last check is: 0: HEALTHY"
echo "abnormal death tally for database_upkeep since last check is: 0: HEALTHY"
