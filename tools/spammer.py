...
# connect and receive all the data. export SPAM=True to enable acarshub.py to function properly
...
# env ACARSHUB_DB=sqlite:////Users/fred/messages.db SPAM=True DEBUG_LOGGING=True ENABLE_ACARS=True FREQS_ACARS="130.025;130.450;131.125;131.550" python3 acarshub.py
